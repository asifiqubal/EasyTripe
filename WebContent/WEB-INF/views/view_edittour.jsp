							...
							<form method="POST" name="addtour" id="addtour" class="form-horizontal" >
								<div id="touraddFormDiv">
									...
									<div class="column-count">
										<input type="hidden" name="tourid" value="${td.tourid}">
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-xs-10">
													<input type="text" name="tourname" id="tourname"
														placeholder="Enter name" class="form-control" value="${td.tourname}"
														required="required">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-xs-10">
													...
													<input type="text" name="tourdate" id="tourdate"
														...
														required="required" value="${td.tourdate}">
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-xs-10">
													<input type="number" min="1" max="15" name="totalday"
														...
														class="form-control" required="required" value="${td.totalday}">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-4 col-xs-12 control-label"
												...
												<div class="col-sm-6 col-xs-10">
													<input type="number" min="0" max="15" name="totalnight"
														...
														class="form-control" required="required" value="${td.totalnight}">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-xs-10">
													<input type="text" name="startcity" id="startcity"
														...
														value="${td.startcity}" required="required">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-xs-10">
													<input type="text" name="endcity" id="endcity"
														placeholder="Enter Endcity" class="form-control" value="${td.endcity}"
														required="required">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-xs-10">
													<input type="text" name="visitingcities"
														...
														class="form-control" value="${td.visitingcities}" required="required">
												</div>
											</div>
											<input type="hidden" id="tdiv" value="${td.tourdivision}">
											<div class="form-group">
												<label class="col-sm-4 col-xs-12 control-label"
											...
											<div class="form-group">
												<label class="col-sm-4 col-xs-12 control-label"
													...
													class="required">*</span></label>
												<div class="col-sm-6 col-xs-10">
													<textarea row="3" cols="60" name="placedetails"
														id="placedetails" placeholder="Enter Place Details max 1000 char" maxlength="1000"
														class="form-control" required="required">${td.placedetails}</textarea>
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-xs-10">
														<input type="number" name="costperperson"
															...
															placeholder="Enter Cost Per Person" value="${td.costperperson}">
													</div>
												</div>
											</div>
											<div class="col-md-6 col-sm-6">
												<div class="form-group">
													...
													<div class="col-sm-6 col-xs-10">
														<input type="number" name="costperchildren"
															...
															class="form-control" size="35"
															placeholder="Enter Cost Per Child" value="${td.costperchildren}">
									...
									<a herf="/easytrip/managetour"><button class="btn-danger btn ">Cancel</button></a>
