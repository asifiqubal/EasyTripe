								...
								<tbody id="myTable">
									<c:forEach var="bl" items="${bookinglist}">
										<tr>
											...
											<td>${bl.userid}</td>
											<td>${bl.username}</td>
											<td>${bl.bookingdate}</td>
											<td>Adult:${bl.adultnum}, Child:${bl.childnum}</td>
											<td>${bl.totalcost}</td>
											<td>${bl.status}</td>
											<td>${bl.payment}</td>
											<td><a href="/easytrip/confirmbooking?bookingid=${bl.bookingid}&an=${bl.adultnum}&cn=${bl.childnum}" onclick="return confirm('Are you sure you want to Confirm this Booking?')"><button id="btn" class="btn-success btn ">Confirm</button></a></td>
											<td><a href="/easytrip/cancelbooking?bookingid=${bl.bookingid}&an=${bl.adultnum}&cn=${bl.childnum}"  onclick="return confirm('Are you sure you want to Cancel this Booking?');"><button id="btn" class="btn-danger btn ">Cancel Tour</button></a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
