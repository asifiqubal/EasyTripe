						...
						<div class="panel-heading">
							<div class="row">
								<div class="col col-xs-12">
									<h3 class="panel-title">Requested Tour List</h3>
								</div>
									...
									<c:forEach var="rl" items="${requestlist}">
										<tr>
											...
											<td class="hidden-xs"><a
												href="/easytrip/tourdetails?tourid=${rl.tourid}"
												class="preview">${rl.tourid}</a></td>
											<td>${rl.adultnum}</td>
											<td>${rl.childnum}</td>
											<td>${rl.totalcost}</td>
											<td>${rl.bookingdate}</td>
											<td>${rl.status}</td>
										</tr>
									</c:forEach>
								</tbody>
				...
				<div class="">
					...
					<div class="col-md-12 col-sm-8 panel panel-default panel-table">
						<div class="panel-heading">
							<div class="row">
								<div class="col col-xs-12">
									<h3 class="panel-title">Paid Tour List</h3>
								</div>
						...
						<div class="">
							<table
								...
								<tbody id="myTable">
									<c:forEach var="pl" items="${paidlist}">
										<tr>
											<td>${pl.bookingid}</td>
											<td>${pl.tourid}</td>
											<td>${pl.adultnum}</td>
