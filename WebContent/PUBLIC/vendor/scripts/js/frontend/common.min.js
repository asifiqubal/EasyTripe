	...
	if(settingObj.saveItem)
	{
		...
		$(settingObj.saveItem.link_id).click(function() {
			...
			$.ajax({
				  ...
				  data: { id: id },
				  beforeSend: function(){
				  			var loader = (settingObj.saveItem.image_loader_class)	? settingObj.saveItem.image_loader_class	: '<img src="'+settingObj.saveItem.image_loader_url+'" border="0" height="15" />';
							$(self).html(loader);
						 },
				  ...
				  success: function(response){
					...
					try
					{
						...
						{
							commonMsgDialog(settingObj, errMsgDesign(json_arr.msg, 'warning'));
						}
					}
					catch(error)
					{
...
function commonAddFormError(key,errMsg)
{
	...
	{
		var msg_field = (window.settingObj && settingObj.form_action && settingObj.form_action.common_msg_field_id) ? settingObj.form_action.common_msg_field_id : 'actionMessage';
